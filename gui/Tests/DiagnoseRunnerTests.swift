...
@Test func expandedReportProducesPrivacySafeDeveloperRows() throws {
    ...
    #expect(rows.first(where: { $0.id == "guest_versions" })?.value == "Alpine 3.23.5 · ntfs-3g 2026.7.7-r0 · nfs-utils 2.6.4-r6")
