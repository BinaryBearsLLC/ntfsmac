...
| --- | --- | --- |
| macOS 26.6.2, Apple M5 (physical Mac) | Official notarized Beta 2 (31304): app/helper update, NTFS write/flush/remount/SHA-256 checks; mixed NTFS/ExFAT detection previously checked on 31302 | Beta 2 ext2/ext3/ext4 acceptance, other M-series models and longer-term workloads |
