...
BB-03 and BB-01 now pass their installed corrected candidates. The live ledger therefore contains
25 `PASS`, three measured `FAIL`, and two resource `BLOCKED` rows. Remaining failures are
