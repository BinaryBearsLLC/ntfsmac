...
feature list. The status below was audited against `main` at `fd23d3f` on 2026-08-04.
...
Each row is a separate review unit. Branch names are suggestions and should keep the repository's
normal prefix/convention at implementation time.
...
| [`GUI-PLAN.md`](../GUI-PLAN.md) | Current GUI behavior contract and shipped/partial/planned status |
