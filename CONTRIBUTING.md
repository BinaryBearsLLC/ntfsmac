...
[`BinaryBears roadmap`](docs/BINARYBEARS_ROADMAP.md), then read
[`docs/dev/PLAN.md`](docs/dev/PLAN.md) for the historical architecture/build plan and, for GUI
work, [`GUI-PLAN.md`](GUI-PLAN.md) for the current behavior contract. [`CLAUDE.md`](CLAUDE.md) /
...
- Pull requests for BinaryBears roadmap work target `BinaryBearsLLC/ntfsmac:main`. Upstream
