...
> Current product priorities and incomplete integrations live in
> [`docs/BINARYBEARS_ROADMAP.md`](docs/BINARYBEARS_ROADMAP.md).
...
This table describes the current BinaryBears GUI, not the original aspirational phase list.
...
| Shipped | In-popover Settings, canonical version/build, Launch at login, contextual help, and adaptive menu-bar icon |
